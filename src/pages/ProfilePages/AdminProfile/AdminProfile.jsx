            ...
            <div className={s.contentItem}>
                ...
                <div className={s.aboutHotelItems}>
                    <div className={s.aboutHotelItem}>
                        <span>Numarul Total de Locuri In Hotel:</span><span>{props.totalCapacity}</span>
                    </div>
                    <div className={s.aboutHotelItem}>
                        <span>Numarul Total de Locuri Ocupate la Moment:</span><span>{props.totalGuestInHotel}</span>
                    </div>
                    <div className={s.aboutHotelItem}>
                        <span>Numarul Total de Rezervari: </span><span>{props.totalRentPeriods}</span>
                    </div>
                    <div className={s.aboutHotelItem}>
                        <span>Numarul Total de Locuri Libere:</span><span>{props.totalCapacity-props.totalGuestInHotel}</span>
                    </div>
                    <div className={s.aboutHotelItem}>
                        <span>Rooms To Clean:</span><span>{props.totalRoomsToClean}</span>
                    </div>
                </div>
            </div>
